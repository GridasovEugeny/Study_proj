### Детальное описание c ТЗ повявляется при переходе на конкретный проект. Для открытия проекта необходимо нажать на файл с расширением .ipynb прим. Sample_name.ipynb
